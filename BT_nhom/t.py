...
print(y_pred_T)
print('.................................')
z=[[ 0,1,22,20,17,12,7,3,133.583241,36.528715,10,1.972521,0.183782,0.002088,0.8,0.000000,0.499141,0]]
test=model_T.predict(z)
print('Gia tri vao')
print(z)
...
if(test==0):
    print('=> KHONG CO BENH')
     ...
     print('=> MAC BENH VONG MAC TIEU DUONG')
print('--------------------------------------')    
